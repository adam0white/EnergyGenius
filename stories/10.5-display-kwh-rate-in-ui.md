...
<div className="space-y-1 border-t pt-2 mt-2">
	<div className="flex justify-between text-sm">
		...
		<span className="font-semibold text-gray-900">${recommendation.baseRate?.toFixed(3)}/kWh</span>
	</div>
	<div className="flex justify-between text-sm">
		<span className="text-gray-600">Monthly Service Fee:</span>
		<span className="font-semibold text-gray-900">${recommendation.monthlyFee?.toFixed(2)}</span>
	</div>
	<div className="flex justify-between text-sm border-t pt-1 mt-1">
		<span className="text-gray-600">Est. Monthly Cost:</span>
		<span className="font-bold text-gray-900">${recommendation.monthlyPrice?.toFixed(2)}</span>
	</div>
</div>;
```
