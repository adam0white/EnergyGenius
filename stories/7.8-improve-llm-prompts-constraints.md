...
- [ ] Investigate Issues (AC: Investigate Current LLM Prompt Issues)
  - [ ] Find and review prompt code
  - [ ] Generate test recommendations
  - [ ] Document fictional plans being recommended
  - [ ] Analyze why it's happening

- [ ] Refactor Prompts (AC: Refactor Prompts for Real Data Only)
  - [ ] Rewrite recommendation prompt
  - [ ] Include full plan list in context
  - [ ] Add explicit constraints
  - [ ] Update prompt builder code

- [ ] Add Validation (AC: Add Strict Validation of Claude Responses)
  - [ ] Create validation function
  - [ ] Check each recommended plan exists
  - [ ] Handle validation failures
  - [ ] Add comprehensive logging

- [ ] Improve Structure (AC: Improve Prompt Structure)
  - [ ] Reorganize prompt template
  - [ ] Separate concerns clearly
  - [ ] Add conditional logic
  - [ ] Test prompt clarity

- [ ] Test Thoroughly (AC: Test Improved Prompts)
  - [ ] Write unit tests for validation
  - [ ] Write integration tests
  - [ ] Manual test various scenarios
  - [ ] Regression test existing functionality

- [ ] Document & Deploy (AC: Document & Deploy)
  - [ ] Document prompt changes
